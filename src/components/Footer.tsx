        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="mailto:optic.specphotography@gmail.com" className="flex items-center gap-3 text-white/40 hover:text-gold text-sm transition-colors duration-300"><Mail size={16} /> contact@opticspecs.com</a>
