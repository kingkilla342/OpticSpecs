...
const photographers = [
  {
    ...
    image: "/raymond.png",
    description:
      "Raymond brings a cinematic edge to every frame. Specializing in dramatic lighting, high-fashion portraits, and brand campaigns, his work blends editorial precision with raw emotion. He\u2019s the vision behind Optic Specs.",
    highlights: [
  ...
  },
  {
    ...
    image: "/isayah.png",
    description:
      "Isayah captures life in motion. From street-style fashion to high-energy events, he has a natural eye for candid moments that tell a story. His raw, documentary-style approach gives every shoot an authentic edge.",
    highlights: [
  ...
  },
  {
    ...
    image: "/kav.png",
    description:
      "Kav bridges photography and film. Equally skilled behind the camera for stills and video, he crafts cinematic short films, music videos, and promotional content with a sharp creative eye.",
    highlights: [
              ...
              <div className="glass rounded-xl overflow-hidden group hover:border-gold/25 transition-all duration-500 hover:shadow-lg hover:shadow-gold/5">
                <div className={`bg-gradient-to-r ${p.gradient} p-8 md:p-10`}>
                  <div className="flex flex-col md:flex-row gap-8">
                    {/* Photo */}
                    <div className="w-32 h-40 md:w-44 md:h-56 rounded-xl overflow-hidden shrink-0 relative border border-gold/20 group-hover:border-gold/40 transition-all duration-500 group-hover:shadow-lg group-hover:shadow-gold/10">
                      <Image
                        src={p.image}
                        alt={p.name}
                        fill
